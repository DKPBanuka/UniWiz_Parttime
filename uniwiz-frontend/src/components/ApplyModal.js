    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 p-4">
            <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-lg relative">
                ...
                <h2 className="text-2xl font-bold text-dark-blue-text mb-2">Apply for: {jobTitle}</h2> {/* Changed text color */}
                ...
                <div className="space-y-4">
                    <textarea
                        ...
                        className="shadow-sm border rounded w-full py-3 px-4 h-40 focus:outline-none focus:ring-2 focus:ring-app-light-blue" // Changed focus ring color
                    ...
                    <div className="flex justify-end">
                        <button
                            ...
                            className="bg-app-blue hover:bg-dark-blue-text text-white font-bold py-2 px-6 rounded-lg transition duration-300 disabled:bg-gray-400" // Changed bg and hover bg
                        >
