// FILE: src/components/CompanyProfilePage.js (Updated with new UI/UX and functionality)
// =======================================================================================
...
const InfoCard = ({ icon, title, children, className = '' }) => (
    <div className={`bg-white p-6 rounded-xl shadow-md border border-gray-100 h-full ${className}`}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            <InfoCard title="About Us" icon={AboutIcon}>
                                <p className="text-gray-700 leading-relaxed whitespace-pre-wrap">{company.about || 'No description provided.'}</p>
                            </InfoCard>
                            ...
                            <InfoCard title="Active Jobs" icon={JobsIcon}>
                                <div className="space-y-4">
                                    {jobs.length > 0 ? jobs.map((job) => {
                                        ...
                                        return (
                                            <div key={job.id} className="bg-gray-50 p-4 rounded-lg flex justify-between items-center hover:bg-gray-100 transition-colors">
